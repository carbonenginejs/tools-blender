...
class CARBON_PT_sidebar_about(Panel):
    ...
    def draw(self, context):
        ...
        self.layout.prop(prefs, "sprite_boost", slider=True)
        self.layout.prop(prefs, "plane_boost", slider=True)
        lights = self.layout.column(align=True)
        lights.prop(prefs, "light_emitters", text="Light emitters")
        light_controls = lights.row(align=True)
        light_controls.enabled = prefs.light_emitters
        light_controls.prop(prefs, "light_boost", text="Boost", slider=True)
        light_controls.prop(prefs, "light_falloff", text="Falloff", slider=True)
