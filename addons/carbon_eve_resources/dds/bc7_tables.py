# Generated from runtime/src/resource/formats/dds/core/bc7.js -- do not hand-edit.
# Tables are the Khronos Data Format Specification, section 20.1.

#: subsets, partition, rotation, selection, colour, alpha, endpointP, sharedP, index, secondaryIndex
MODES = (
    (3, 4, 0, 0, 4, 0, 1, 0, 3, 0),
    (2, 6, 0, 0, 6, 0, 0, 1, 3, 0),
    (3, 6, 0, 0, 5, 0, 0, 0, 2, 0),
