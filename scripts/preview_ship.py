...
# The quad material builder lives in the ADD-ON, not here. There must be one
# answer to what a material looks like, and when there were two -- the panel's
# approximation and this script's accurate path -- two ships in one scene
# looked like different games.
